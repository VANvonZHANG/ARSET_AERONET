...
for i in range(len(location_list)):
    try:
        ...
        #path_AERONET = r'C:/Users/pgrigoro/Documents/dosadka/files/'+location_list[i]+'.txt'
        #path_GOES = r'C:/Users/pgrigoro/Documents/GOES_SITE/'+location_list[i]+'.txt'
        ...
        if len(df_AERONET) > 0:
            ...
            if 'AOT550' in df.columns:
                ...
                os.makedirs("/raid3/ilya/GOES_R/GOES_AOD/AERONET_GOES", exist_ok=True)
                outpath = '/home/pgrigoro/GOES_satellite_processing/AERONET_GOES/'+location_list[i]+'.csv'
                #outpath = 'C:/Users/pgrigoro/Documents/AERONET_GOES/'+location_list[i]+'.csv'
