...
df = pd.read_csv(r'/raid3/db3/dell8/ilya/SUNPHOTO4/databasecca/locations_v4000.fil', header=None)
...
LATS,LONS = degrees(xarray.open_dataset("/raid3/ilya/GOES_R/GOES_AOD/sample_g16.nc"))
#LATS,LONS = degrees(xarray.open_dataset("/raid3/ilya/GOES_R/GOES_AOD/sample_g18.nc"))
...
C = xarray.open_dataset("/raid3/ilya/GOES_R/GOES_AOD/g16_east_vza.nc")
...
df_combined.to_csv('/raid3/ilya/GOES_R/GOES_AOD/LatLon_Collocation_G16.csv',index=False) #saves the combined dataframe as a csv file
#df_combined.to_csv('/raid3/ilya/GOES_R/GOES_AOD/LatLon_Collocation_G18.csv',index=False) #saves the combined dataframe as a csv file